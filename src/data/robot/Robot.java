...
public abstract class Robot {
	 ...
	 */
	private int calculTemps(Case src, Case voisin) {
		...
		int taille_case = this.getCarte().getTailleCases();
    ...
    if (this.possibleRemplissage(this.getCase())) {
      ...
      date = date + this.getTempsRemplissage();
      /* Ajout au simulateur du remplissage */
      this.ajoutSimulateurRemplissage(sim, date); // A revoir pourquoi donner la date de fin de remplissage [PHILEMON]
    }
  }
